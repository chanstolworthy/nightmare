...
.then(function() {
    ...
    .then(function() {
        return nightmare
            ...
            .then(function(result){
                if (result) {
                    return console.log(chalk.red('   + View Zip Code: PASS'))
                } else {
                    console.log(chalk.green('   - View Zip Code: FAIL - PERMISSIONS ERROR!'))
                }
            })
    })
    .then(function() {
...
.then(function() {
    return nightmare
        ...
        .then(function(result){
            if (result) {
                return console.log(chalk.green('   - View Edit Assets Button:  FAIL - PERMISSIONS ERROR!'))
            } else {
                console.log(chalk.red('   + View Edit Assets Button: PASS'))
            }
        })
})
.then(function() {
...
.then(function(){ 
    return nightmare
        ...
        .then(function (result) {
            ...
            console.log(' ')
            if (result) {
                return console.log(chalk.red('   - View Notes Tab Disabled: FAIL - PERMISSIONS ERROR!'))
            } else {
                console.log(chalk.green('   + View Notes Tab Disabled: PASS'))
    }
})
})
.then(function() {
