...
.then(function() {
    ...
    .then(function(){
        return nightmare
            ...
            .then(function(result){
                if(result) {
                    return console.log(chalk.green('   + Edit First Name: PASS'))
                } else {
                    console.log(chalk.red("   - Edit First Name: FAIL - PERMISSIONS ERROR!"))
                }
            })
    })
    .then(function() {
        return nightmare
            ...
            .then(function(result){
                if (result) {
                    return console.log(chalk.green('   + Edit Middle Initial: PASS'))
                } else {
                    console.log(chalk.red("   - Edit Middle Initial: FAIL - PERMISSIONS ERROR!"))
                }
            })
    })
    .then(function() {
        return nightmare
            ...
            .then(function(result){
                if (result) {
                    return console.log(chalk.green('   + Edit Last Name: PASS'))
                } else {
                    console.log(chalk.red("   - Edit Last Name: FAIL - PERMISSIONS ERROR!"))
                }
            })
    })
    .then(function() {
    ...
    .then(function() {
        return nightmare
            ...
            .then(function(result){
                if (result) {
                    return console.log(chalk.green('   + Edit Gender: PASS'))
                } else {
                    console.log(chalk.red("   - Edit Gender: FAIL - PERMISSIONS ERROR!"))
                }
            })
    })
    .then(function() {
        return nightmare
            ...
            .then(function(result){
                if (result) {
                    return console.log(chalk.green('   + Edit Birthday: PASS'))
                } else {
                    console.log(chalk.red("   - Edit Birthday: FAIL - PERMISSIONS ERROR!"))
                }
            })
    })
    .then(function() {
    ...
    .then(function() {
        return nightmare
            ...
            .then(function(result){
                if (result) {
                    return console.log(chalk.green('   + Edit Social Security Number: PASS'))
                } else {
                    console.log(chalk.red("   - Edit Social Security Number: FAIL - PERMISSIONS ERROR!"))
                }
            })
    })
    .then(function() {
    ...
    .then(function(){
        ...
        .wait(25)
            ...
            .then(function(result){
                if(result) {
                    return console.log(chalk.green('   + Edit Primary Email: PASS'))
                } else {
                    console.log(chalk.red("   - Edit Primary Email: FAIL - PERMISSIONS ERROR!"))
                }
            })
    })
    .then(function(){
    ...
    .then(function(){
        ...
        .wait(25)
            ...
            .then(function(result){
                if(result) {
                    return console.log(chalk.green('   + Edit Address: PASS'))
                } else {
                    console.log(chalk.red("   - Edit Address: FAIL - PERMISSIONS ERROR!"))
                }
            })
    })
    .then(function(){
        ...
        .wait(25)
            ...
            .then(function(result){
                if(result) {
                    return console.log(chalk.green('   + Edit City: PASS'))
                } else {
                    console.log(chalk.red("   - Edit City: FAIL - PERMISSIONS ERROR!"))
                }
            })
    })
    .then(function(){
        ...
        .wait(25)
            ...
            .then(function(result){
                if(result) {
                    return console.log(chalk.green('   + Edit State: PASS'))
                } else {
                    console.log(chalk.red("   - Edit State: FAIL - PERMISSIONS ERROR!"))
                }
            })
    })
    .then(function(){
        ...
        .wait(25)
            ...
            .then(function(result){
                if(result) {
                    return console.log(chalk.green('   + Edit Zip Code: PASS'))
                } else {
                    console.log(chalk.red("   - Edit Zip Code: FAIL - PERMISSIONS ERROR!"))
                }
            })
    })
    .then(function(){
...
.then(function(){ 
    return nightmare
        ...
        .then(function (result) {
            ...
            console.log(' ')
            if (result) {
                return console.log(chalk.green("   + View Notes Tab: PASS"))
            } else {
                console.log(chalk.red("   - View Notes Tab: FAIL - PERMISSIONS ERROR!"))
    }
})
})
.then(function() {
    return nightmare
        .wait(25)
        .goto(vars.mainUrl + '/employee/notes/' + vars.AdminID)
        .wait(1500)
...
.then(function() {
    return nightmare
        .wait(25)
        .goto(vars.mainUrl + '/employee/documents/' + vars.AdminID)
        .wait(1500)
...
.then(function(){
    ...
    .then(function(){
        console.log(' ')
        console.log('A D M I N - S E L F   C O M P L E T E')
        console.log(' ')
    })
